...
| **Instrucciones escondidas en un documento** (inyección de instrucciones) | Un PDF que diga "ignorá lo anterior" podría influir la respuesta | Los documentos entran como datos; el modelo no tiene herramientas que ejecuten acciones; la salida se fuerza a un esquema JSON y el código valida ids | No se probó con documentos maliciosos: es un riesgo no verificado |
...
- No se probaron documentos adversariales ni un segundo cliente.
