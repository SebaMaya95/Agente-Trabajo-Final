...
| **Categoría (Detalle) equivocada** | El reporte por categoría distorsiona importes por rubro | La tabla manda y el modelo no la puede reescribir (guarda en código, con excepción de los VEP de AFIP/ARCA); las convenciones de la persona están escritas; lo deducido va en celeste; se agrupa aparte lo "sin categorizar" | Detalle exacto 100% sobre celdas validadas (40/40) en la versión final, ajustada sobre este mismo mes (v5: 88%) |
...
| **No determinismo**: la misma entrada puede dar salidas distintas | Un caso ambiguo se resuelve distinto de un mes a otro o entre dos corridas | Los casos ambiguos van a revisión humana; las guardas en código fijan lo que no debe variar (tabla, período, número de comprobante, exclusividad) | Repetir v4 cambió 26 de 143 filas (mayormente de redacción); la versión final repetida tres veces dio 98%, 99% y 98% en comprobantes (`DECISIONES.md`, D15 y D18) |
