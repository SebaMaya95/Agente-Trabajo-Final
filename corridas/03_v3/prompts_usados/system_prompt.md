...
- Convenciones de categoría del cliente: VEP de impuestos nacionales (ARCA, ex AFIP) → `Impuesto - ARCA - <Ganancias | IVA | ...>`; VEP de cargas sociales (F.931, seguridad social) → `Personal - Leyes - <nombre corto de la empresa>`; retiros de efectivo con tarjeta → `Pagos en efectivo`.
...
# EJEMPLOS
Entrada: {"n":7,"concepto":"Transferencia realizada - A Ferretería Sur SRL / - fac / 30111111111","importe":-<importe-real-1>,"sugerencia_tabla":"Maquinaria - Ferretería - Ferretería Sur","candidatos":[{"doc":"doc_031","rol":"origen","emisor":"Ferretería Sur SRL","numero":"A 0003-00001234","importes":[{"etiqueta":"total","monto":<importe-real-1>}],"pertenece":"si","coincide_importe":true,"coincide_cuit":true}]}
...
Entrada: {"n":20,"concepto":"Debito automatico - Asociacion Ejemplo","importe":-<importe-real-2>,"sugerencia_tabla":"Asesoramiento - Asociación - Ejemplo","candidatos":[{"doc":"doc_053","rol":"origen","emisor":"Asociación Ejemplo","numero":"<n-real-1>","importes":[{"etiqueta":"total","monto":<importe-real-3>}],"pertenece":"si","coincide_importe":false,"coincide_nombre":true,"suma_con":"doc_070"},{"doc":"doc_070","rol":"origen","emisor":"Asociación Ejemplo","numero":"<n-real-2>","importes":[{"etiqueta":"total","monto":<importe-real-4>}],"pertenece":"si","coincide_importe":false,"coincide_nombre":true,"suma_con":"doc_053"}]}
Salida: {"n":20,"docs":["doc_053","doc_070"],"comprobante":"<n-real-1> ; <n-real-2>","detalle":"Asesoramiento - Asociación - Ejemplo","detalle_origen":"tabla","confianza":"alta","motivo":"dos facturas del mismo emisor suman el débito"}
