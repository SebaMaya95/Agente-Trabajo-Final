...
- Tipos que **no justifican un pago** y llevan `rol=otro`: remitos, guías y documentos de tránsito de hacienda, certificados de retención y e-cheqs.
...
- VEP: en `identificador`, "Tipo de Pago: <como está impreso> | Concepto: <como está impreso>".
